...
STYLES = {'basic': { 'model':'jzli/realcartoonXL-v6',
          ...
          'photo': { 'model':'n0madic/colossusProjectXL_v53',
                     ...
                     'pre_prompt':'photo of ',
                     'positive_expansion':'photographic, realistic, realism, photography, f/2.8, 35mm photo, highly detailed, intricate, cinematic, bokeh, elegant, sharp, fine detail, aesthetic, pretty, raw photo, photorealistic, 4K, stock photo, natural soft light, detailed face, film grain, high iso, vignette, DoF',
          ...
          '3d':    { 'model': 'stablediffusionapi/protovisionxl-v3',
                     ...
                     'positive_expansion':'3d model, video game character, volumetric light, 4k, 3d render, active, dynamic, highly detailed, dimensional, dramatic light, elegant, sharp, vivid colors, fine detail, fair quality, aesthetic, pretty, attractive, enhanced, bright, clear, artistic, CGI, high poly',
          ...
          'art':   { 'model':'jzli/realcartoonXL-v6',
                     'lora': {
                              'name':'gvrizzo/lora-sdxl-drawing',
